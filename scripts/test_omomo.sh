python src/eval.py trainer.devices=\'0,\'  data=omomo data.joint_format=behave_joint_5 data.batch_size=32 \
    model=chainhoi_omomo     seed=2024 model.gcn_denoiser.joint_dim=12 model.gcn_denoiser.num_layers=6     \
