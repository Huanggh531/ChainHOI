...
class unit_gcn(nn.Module):
    ...
    def __init__(self,
        ...
        self.bn = nn.GroupNorm(group_size, out_channels) # build_norm_layer(self.norm_cfg, out_channels)[1]
    ...
    def forward(self, x, A=None):
        ...
        #n:batch_size,c:64维度 t:帧数 v:节点数
        n, c, t, v = x.shape
        ...
        if self.conv_pos == 'pre':
            x = self.conv(x)
            x = x.view(n, self.num_subsets, -1, t, v)#torch.Size([32, 3, 64, 196, 25])
