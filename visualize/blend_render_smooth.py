...
def render_image(motions, name, frame_dir, video_dir, sequence_dir, mesh_dir,
                 ...
                 keyframe_id, only_keyframe, image_quality, sigma, regen, gold):
...
def get_args():
    ...
    parser.add_argument("--file_dir", type=str, default="./visual_datas/eccv/joints", help='motion npy file dir',
                        required=False)
    parser.add_argument("--frame_dir", type=str, default="./visual_datas/eccv/frames/", help='save dir')
    parser.add_argument("--video_dir", type=str, default="./visual_datas/eccv/videos/", help='save dir')
    parser.add_argument("--sequence_dir", type=str, default="./visual_datas/eccv/sequences/", help='save dir')
    parser.add_argument("--mesh_dir", type=str, default="./visual_datas/eccv/meshes/", help='save dir')
...
def go():
    ...
    for filename in filename_list:
        ...
        render_image(motion, name=filename, frame_dir=args.frame_dir, video_dir=args.video_dir,
                     ...
                     sigma=args.sigma, regen=args.regen, gold=args.gold)
