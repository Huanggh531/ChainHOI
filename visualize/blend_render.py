...
def get_args():
    ...
    parser.add_argument("--video_dir", type=str, default="./visual_datas/gen_mesh_visual/", help='save dir')
    parser.add_argument("--sequence_dir", type=str, default="./visual_datas/sequences/", help='save dir')
    parser.add_argument("--mesh_dir", type=str, default="./visual_datas/gen_mesh_visual/", help='save dir')
...
def go():
    ...
    for index,filename in enumerate(filename_list):
        ...
        for file in sub_files:
            name=file.split(".")[0]
            data[name]=np.load(os.path.join(filename_path,filename,file))
        
        print('processing: ', filename)
        render_image(data, name=filename, frame_dir=args.frame_dir, video_dir=args.video_dir,
